...
export default function LoveSparkCalculator() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const compatibilityPercentage = calculateCompatibility(
      values.name1,
      values.name2
    );
  ...
  return (
    <Card className="w-full max-w-md shadow-2xl shadow-primary/10">
      <CardHeader className="text-center">
        <h2 className="text-3xl font-headline tracking-wider text-accent mx-auto">
          Find Your Spark!
        </h2>
          ...
          {result && (
            ...
            >
              <h3 className="text-xl font-headline text-primary">
                {result.names.name1} & {result.names.name2}
              </h3>
              <Sparkles>
                <div className="relative w-40 h-40 mx-auto flex items-center justify-center">
                  ...
                  <span className="text-4xl font-headline text-accent">
                    {result.percentage}%
                  </span>
                </div>
              </Sparkles>
              <p className="font-body text-lg leading-relaxed text-foreground/80 px-4">
                {result.message}
              </p>
            </motion.div>
          )}
